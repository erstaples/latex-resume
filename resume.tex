...
\name{Eric R.}{Staples}
\address{11200 Greenwood Ave N, #34, Seattle, WA 98133}
\mobile{(206) 954-1418}

\email{erstaples@gmail.com}
\github{erstaples}
\linkedin{erstaples}
\stackoverflow{1774723}{erstaples}
%\linkedin{linkedin name}
%\extrainfo{test} % Other text you want to include on this line

\position{Software Engineer{\enskip\cdotp\enskip}Kubernetes Expert} % Your expertise/fields

\makecvfooter{\today}{Eric R. Staples~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
